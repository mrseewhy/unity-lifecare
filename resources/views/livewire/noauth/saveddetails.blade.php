<div>
    ...
    @livewire('partials.pagehead', ['title' => 'Continue your form'])
    <div class="max-w-7xl mx-auto my-16 text-purple-900">
        <div class="mb-12">
        ...
        <div x-data="{
            ...
            <!--            <button-->
            <!--                @click="if (num <= maxStep) step = num"-->
            <!--                class="w-10 h-10 md:w-16 md:h-16 text-sm md:text-lg font-head font-bold flex items-center justify-center rounded-full text-white transition"-->
            <!--                :class="{
                -- >
                <
            ...
            <!--            </button>-->
            <!--            <div x-show="index < 5" class="w-10 md:w-12 h-1 transition"-->
            <!--                :class="{
                -- >
                <
                !--'bg-green-500': num < maxStep, -- >
                    <
                    !--'bg-gray-300': num >= maxStep-- >
                    <
                    !--
            }">-->
            <!--            </div>-->
            ...
            {{-- 
            <div x-show="step === 1">
                <h2 class="text-3xl font-medium font-head mb-12 mt-8">Step 1: Participant Information</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
                    <div>
                        ...
                        <input type="text" wire:model="participants_name"
                            class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                    ...
                    <div>
                        ...
                        <input type="date" wire:model="DOB" class="w-full border border-gray-300 p-2 rounded">
                        @error('DOB')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center cursor-pointer font-body text-lg">
                                <input type="radio" wire:model="gender" value="male" class="mr-2 font-body text-lg">
                                Male
                            </label>
                            <label class="flex items-center cursor-pointer font-body text-lg">
                                <input type="radio" wire:model="gender" value="female" class="mr-2 font-body text-lg">
                                Female
                            </label>
                        </div>
                        @error('gender')
                ...
                <!-- Row 2: NDIS Number, Home Phone, Mobile Phone -->
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
                    <div>
                        <label class="block text-base font-medium font-head mb-2">NDIS Number</label>
                        <input type="text" wire:model="NDIS_Number"
                            class="w-full border border-gray-300 p-2 rounded font-body text-sm" maxlength="20">
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center cursor-pointer font-body text-lg">
                                <input type="radio" wire:model="interpreter_required" value="yes"
                                    class="mr-2 font-body text-lg"> Yes
                            </label>
                            <label class="flex items-center cursor-pointer font-body text-lg">
                                <input type="radio" wire:model="interpreter_required" value="no"
                                    class="mr-2 font-body text-lg"> No
                            </label>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-10">
                    ...
                    <div>
                        <label class="block text-base font-medium font-head mb-2">Postal Address: <span
                                class="text-sm text-gray-600">If not the same as Residential Address</span></label>
                ...
                <!-- Row 5: Guardianship in Place, Behaviour Management Plan -->
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-10">
                    <div>
                        <label class="block text-base font-medium font-head mb-2">Is there a Guardianship and/or
                            Administration order in place?</label>
                        <div class="flex gap-4">
                            <label class="flex items-center cursor-pointer font-body text-lg">
                                <input type="radio" wire:model="guardianship_in_place" value="yes"
                                    class="mr-2 font-body text-lg"> Yes
                            </label>
                            <label class="flex items-center cursor-pointer font-body text-lg">
                                <input type="radio" wire:model="guardianship_in_place" value="no"
                                    class="mr-2 font-body text-lg"> No
                            </label>
                        </div>
                    ...
                    <div>
                        <label class="block text-base font-medium font-head mb-2">Is there a Behaviour Management Plan
                            in place?</label>
                        <div class="flex gap-4">
                            <label class="flex items-center cursor-pointer font-body text-lg">
                                <input type="radio" wire:model="behaviour_management_plan_in_place" value="yes"
                                    class="mr-2 font-body text-lg"> Yes
                            </label>
                            <label class="flex items-center cursor-pointer font-body text-lg">
                                <input type="radio" wire:model="behaviour_management_plan_in_place" value="no"
                                    class="mr-2 font-body text-lg"> No
                            </label>
                        </div>
            ...
            <div x-show="step === 2">
                <h2 class="text-3xl font-medium font-head mb-12 mt-2">Step 2: Guardian Information</h2>
                ...
                <!-- Guardian 1 -->
                <h3 class="text-2xl font-medium font-head mb-6 mt-24">Guardian 1</h3>

                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
                    <div>
                        <label class="block font-medium font-head mb-2">Name<span class="text-red-600">*</span></label>
                        <input type="text" wire:model="guardian_1_name" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('guardian_1_name') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label class="block font-medium font-head mb-2">Primary Carer</label>
                        <div class="flex gap-4">
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="guardian_1_as_primary_carer" value="yes" class="mr-2 font-body text-lg" > Yes</label>
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="guardian_1_as_primary_carer" value="no" class="mr-2 font-body text-lg"> No</label>
                        </div>
                        @error('guardian_1_as_primary_carer') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label class="block font-medium font-head mb-2">Lives with Participant</label>
                        <div class="flex gap-4">
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="participant_lives_with_guardian_1" value="yes" class="mr-2 font-body text-lg"> Yes</label>
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="participant_lives_with_guardian_1" value="no" class="mr-2 font-body text-lg"> No</label>
                        </div>
                        @error('participant_lives_with_guardian_1') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-10">
                    <div>
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="guardian_1_as_emergency_contact" value="yes" class="mr-2 font-body text-lg"> Yes</label>
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="guardian_1_as_emergency_contact" value="no" class="mr-2 font-body text-lg"> No</label>
                        </div>
                        @error('guardian_1_as_emergency_contact') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label class="block font-medium font-head mb-2">Relationship to Participant</label>
                        <div class="flex gap-4">
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="guardian_1_relationship_to_participant" value="parent" class="mr-2 font-body text-lg"> Parent</label>
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="guardian_1_relationship_to_participant" value="guardian" class="mr-2 font-body text-lg"> Guardian</label>
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="guardian_1_relationship_to_participant" value="caregiver" class="mr-2 font-body text-lg"> Caregiver</label>
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="guardian_1_relationship_to_participant" value="other" class="mr-2 font-body text-lg"> Other</label>
                        </div>
                        @error('guardian_1_relationship_to_participant') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-10">
                    <div>
                        <label class="block font-medium font-head mb-2">Residential Address<span class="text-red-600">*</span></label>
                        <input type="text" wire:model="guardian_1_residential_address" class="w-full border border-gray-300 p-2 rounded font-body text-sm" >
                        @error('guardian_1_residential_address') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Postal Address</label>
                        <input type="text" wire:model="guardian_1_postal_address" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('guardian_1_postal_address') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
                    <div>
                        ...
                        <input type="text" wire:model="guardian_1_home_phone" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('guardian_1_home_phone') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Mobile Phone</label>
                        <input type="text" wire:model="guardian_1_mobile_phone" class="w-full border border-gray-300 p-2 rounded font-body text-sm" >
                        @error('guardian_1_mobile_phone') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Email</label>
                        <input type="email" wire:model="guardian_1_email" class="w-full border border-gray-300 p-2 rounded font-body text-sm" >
                        @error('guardian_1_email') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>

                <!-- Guardian 2 -->
                <h3 class="text-2xl font-medium font-head mb-6 mt-24">Guardian 2</h3>

                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
                    <div>
                        <label class="block font-medium font-head mb-2">Name</label>
                        <input type="text" wire:model="guardian_2_name" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('guardian_2_name') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label class="block font-medium font-head mb-2">Primary Carer</label>
                        <div class="flex gap-4">
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="guardian_2_as_primary_carer" value="yes" class="mr-2 font-body text-lg" > Yes</label>
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="guardian_2_as_primary_carer" value="no" class="mr-2 font-body text-lg"> No</label>
                        </div>
                        @error('guardian_2_as_primary_carer') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label class="block font-medium font-head mb-2">Lives with Participant</label>
                        <div class="flex gap-4">
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="participant_lives_with_guardian_2" value="yes" class="mr-2 font-body text-lg"> Yes</label>
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="participant_lives_with_guardian_2" value="no" class="mr-2 font-body text-lg"> No</label>
                        </div>
                        @error('participant_lives_with_guardian_2') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-10">
                    <div>
                        <label class="block font-medium font-head mb-2">Emergency Contact</label>
                        <div class="flex gap-4">
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="guardian_2_as_emergency_contact" value="yes" class="mr-2 font-body text-lg"> Yes</label>
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="guardian_2_as_emergency_contact" value="no" class="mr-2 font-body text-lg"> No</label>
                        </div>
                        @error('guardian_2_as_emergency_contact') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label class="block font-medium font-head mb-2">Relationship to Participant</label>
                        <div class="flex gap-4">
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="guardian_2_relationship_to_participant" value="parent" class="mr-2 font-body text-lg"> Parent</label>
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="guardian_2_relationship_to_participant" value="guardian" class="mr-2 font-body text-lg"> Guardian</label>
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="guardian_2_relationship_to_participant" value="caregiver" class="mr-2 font-body text-lg"> Caregiver</label>
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="guardian_2_relationship_to_participant" value="other" class="mr-2 font-body text-lg"> Other</label>
                        </div>
                        @error('guardian_2_relationship_to_participant') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-10">
                    <div>
                        ...
                        <input type="text" wire:model="guardian_2_residential_address" class="w-full border border-gray-300 p-2 rounded font-body text-sm" >
                        @error('guardian_2_residential_address') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Postal Address</label>
                        <input type="text" wire:model="guardian_2_postal_address" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('guardian_2_postal_address') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
                    <div>
                        <label class="block font-medium font-head mb-2">Home Phone</label>
                        <input type="text" wire:model="guardian_2_home_phone" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('guardian_2_home_phone') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Mobile Phone</label>
                        <input type="text" wire:model="guardian_2_mobile_phone" class="w-full border border-gray-300 p-2 rounded font-body text-sm" >
                        @error('guardian_2_mobile_phone') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Email</label>
                        <input type="email" wire:model="guardian_2_email" class="w-full border border-gray-300 p-2 rounded font-body text-sm" >
                        @error('guardian_2_email') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
            ...
            <div x-show="step === 3">
                <h2 class="text-3xl font-medium font-head mb-12 mt-2">Step 3</h2>

                <!-- Disability / Medical Conditions -->
                <div class="grid grid-cols-1 gap-12 mb-10">
                    <div>
                        <label class="block font-medium font-head mb-2">2. Disability / Medical Conditions including any diagnosis if relevant</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-10">
                    <div>
                        <label class="block font-medium font-head mb-2">Behaviour Support Plan documents collected for authorisation purposes</label>
                        <div class="flex gap-4">
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="behaviour_support_plan_collected" value="yes" class="mr-2 font-body text-lg"> Yes</label>
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="behaviour_support_plan_collected" value="no"  class="mr-2 font-body text-lg"> No</label>
                        </div>
                        @error('behaviour_support_plan_collected') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Behaviour Support Plan available on NDIS portal?</label>
                        <div class="flex gap-4">
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="behaviour_support_plan_ndis" value="yes" class="mr-2 font-body text-lg" > Yes</label>
                            <label class="flex items-center cursor-pointer font-body text-lg"><input type="radio" wire:model="behaviour_support_plan_ndis" value="no" class="mr-2 font-body text-lg" > No</label>
                        </div>
                        @error('behaviour_support_plan_ndis') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
            </div>
            ...
            <!-- Step 4 -->
            <div x-show="step === 4">
                <h2 class="text-2xl md:text-3xl font-medium font-head mb-4 mt-2">Step 4</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-10">
                    <div>
                        <label class="block font-medium font-head mb-2">Name</label>
                        <input type="text" wire:model="other_services_provider_1_name" class="w-full border border-gray-300 p-2 rounded font-body text-sm" placeholder="E.g John Doe">
                        @error('other_services_provider_1_name') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Address</label>
                        <input type="text" wire:model="other_services_provider_1_address" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('other_services_provider_1_address') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
                    <div>
                        <label class="block font-medium font-head mb-2">Phone</label>
                        <input type="text" wire:model="other_services_provider_1_phone" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('other_services_provider_1_phone') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Email</label>
                        <input type="email" wire:model="other_services_provider_1_email" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('other_services_provider_1_email') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Frequency of Use</label>
                        <input type="text" wire:model="other_services_provider_1_frequency_of_use" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('other_services_provider_1_frequency_of_use') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-10 mt-12 md:mt-24">
                    <div>
                        <label class="block font-medium font-head mb-2">Name</label>
                        <input type="text" wire:model="other_services_provider_2_name" class="w-full border border-gray-300 p-2 rounded font-body text-sm" placeholder="E.g John Doe">
                        @error('other_services_provider_2_name') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Address</label>
                        <input type="text" wire:model="other_services_provider_2_address" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('other_services_provider_2_address') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
                    <div>
                        <label class="block font-medium font-head mb-2">Phone</label>
                        <input type="text" wire:model="other_services_provider_2_phone" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('other_services_provider_2_phone') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Email</label>
                        <input type="email" wire:model="other_services_provider_2_email" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('other_services_provider_2_email') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Frequency of Use</label>
                        <input type="text" wire:model="other_services_provider_2_frequency_of_use" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('other_services_provider_2_frequency_of_use') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
            </div>
            ...
            <!-- Step 5 -->
            <div x-show="step === 5">
                <h2 class="text-2xl md:text-3xl font-medium font-head mb-12 mt-2">Step 5</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
                    <div>
                        <label class="block font-medium font-head mb-2">Medicare Number</label>
                        <input type="text" wire:model="medicare_number" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('medicare_number') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Expiry Date</label>
                        <input type="date" wire:model="expiry_date" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="reference_number" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
                    <div>
                        ...
                        <input type="text" wire:model="membership_number" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('membership_number') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Private Healthcare Provider</label>
                        <input type="text" wire:model="private_healthcare_provider" class="w-full border border-gray-300 p-2 rounded font-body text-sm" >
                        @error('private_healthcare_provider') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Doctor's Name</label>
                        <input type="text" wire:model="doctor_name" class="w-full border border-gray-300 p-2 rounded font-body text-sm" placeholder="E.g. John Doe">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
                    <div>
                        ...
                        <input type="text" wire:model="doctors_phone_number" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('doctors_phone_number') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Address</label>
                        <input type="text" wire:model="doctors_address" class="w-full border border-gray-300 p-2 rounded font-body text-sm" placeholder="E.g. 123, Wallaby Way">
                        @error('doctors_address') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">NDIS Number</label>
                        <input type="text" wire:model="ndis_number" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('ndis_number') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
                    <div>
                        <label class="block font-medium font-head mb-2">NDIS Date</label>
                        <input type="date" wire:model="ndis_date" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('ndis_date') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Name</label>
                        <input type="text" wire:model="ndis_name" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('ndis_name') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Email</label>
                        <input type="email" wire:model="ndis_email" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('ndis_email') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
                <div class="grid grid-cols-1  gap-12 mb-10">
                    <div>
                        <label class="block font-medium font-head mb-2">Comment</label>
                        <textarea wire:model="comment" class="w-full border p-2 rounded" rows="4"></textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
                    <div>
                        ...
                        <input type="text" wire:model="preferred_name" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('preferred_name') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Religious Requirements</label>
                        <input type="text" wire:model="religious_requirements" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('religious_requirements') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Cultural Requirements</label>
                        <input type="text" wire:model="cultural_requirements" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('cultural_requirements') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
                    <div>
                        <label class="block font-medium font-head mb-2">Communication device</label>
                        <input type="text" wire:model="communication_device" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('communication_device') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Physical Assistance</label>
                        <input type="text" wire:model="physical_assistance" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('physical_assistance') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Other Considerations</label>
                        <input type="text" wire:model="other_considerations" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('other_considerations') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
            ...
            <!-- Step 6 -->
            <div x-show="step === 6">
                <h2 class="text-2xl md:text-3xl font-medium font-head mb-12 mt-2">Step 6: Goals and Aspirations</h2>

                <div class="grid grid-cols-1 gap-12 md:mb-10">
                    <div>
                        <label class="block font-medium font-head mb-2">What do you want to achieve for yourself – life skills, physically, socially etc?</label>
                        <textarea wire:model="planned_achievements" class="w-full border p-2 rounded" rows="4"></textarea>
                        @error('planned_achievements') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
                    <div>
                        <label class="block font-medium font-head mb-2">Immediately</label>
                        <input type="text" wire:model="immediate_planned_achievements" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('immediate_planned_achievements') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">In 6 Months</label>
                        <input type="text" wire:model="six_months_planned_achievements" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('six_months_planned_achievements') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Next Year</label>
                        <input type="text" wire:model="next_year_planned_achievements" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('next_year_planned_achievements') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
                <div class="grid grid-cols-1 gap-6 mb-10">
                                    <p>I understand that:</p>
                    <p>- These records are owned by this organisation.</p>
                    <p>- Information within these records will be shared with other staff within the organisation on and only when staff require the information to carry out their duties</p>
                ...
                <div class="mb-10">
                    <label class="flex items-center space-x-2">
                        <input type="checkbox" wire:model="agree" class="rounded border-gray-300 ">
                        <span><span class="text-red-500">*</span> Yes, I agree with the <a href="#" class="text-blue-600 underline">privacy policy</a> and <a href="#" class="text-blue-600 underline">terms and conditions</a>.</span>
                    </label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-10">
                    <div>
                        <label class="block font-medium font-head mb-2">Participant Signature or Parent / caregiver signature<span class="text-red-500">*</span> </label>
                        <input type="text" wire:model="signature" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('signature') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Name of Person Signing<span class="text-red-500">*</span></label>
                        <input type="text" wire:model="name_of_person_signing" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('name_of_person_signing') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Email of Person Signing<span class="text-red-500">*</span></label>
                        <input type="email" wire:model="email_of_person_signing" class="w-full border border-gray-300 p-2 rounded font-body text-sm" required>
                        @error('email_of_person_signing') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Relationship to the participant, if not the participant</label>
                        <input type="text" wire:model="relationship_to_the_participant" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('nrelationship_to_the_participant') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div>
                        <label class="block font-medium font-head mb-2">Date</label>
                        <input type="date" wire:model="date_of_signature" class="w-full border border-gray-300 p-2 rounded font-body text-sm">
                        @error('date_of_signature') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                </div>
            ...
            <!-- Navigation Buttons -->
            <div class="flex flex-row items-center  justify-between gap-8 mt-12 -mb-12">
                <div class="flex items-center space-x-4">
                    ...
                    <button wire:click="saveProgress"
                        class="bg-gray-800 text-sm font-bold text-white px-4 py-2 rounded w-28 h-10 flex items-center justify-center font-head">Save
                        Draft</button>
                </div>
                <div class="flex items-center space-x-4">
